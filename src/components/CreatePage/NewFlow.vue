    ...
    <div class="page sideBarPage" v-bind:class="[getHiddenSidebarClass, getMobileSidebarClass]">
      <div class="largePageWidth main" v-responsive="breakpoints">
        <div>
          ...
          <p>This follows the guide on the <a href="https://vennt.fandom.com/wiki/Character_Creation" target="_blank" class="link">character creation wiki page</a>.</p>
          <p>Choose a name for your character. You can always come back to this step later. Or, press the button to generate a random name for now.</p>
          ...
          <p>This is your starting Item Container. If you buy another item container, it replaces this one.</p>
          <RadioButtonSelection
          ...
          <p>Note: Actually adding these items to your inventory hasn't been implemented yet here, you will need to add them manually on the Character page</p>
          <RadioButtonSelection
          ...
          class="bottomMargin" />
          <p>For now, you need to go to the Character page to select abilities and buy / sell items</p>
...
export default {
  ...
  methods: {
    ...
    createCharacterButton () {
      ...
      this.$store.dispatch('createCharacter', { character: character, redirectToCharacter: true })
    },
    clearCharacter () {
      localStorage.removeItem(CHAR_LOCAL_STORAGE)
