<template>
  <div class="page">
    <div class="mediumPageWidth">
      ...
      Character name:
      <input type="text" name="name" placeholder="Bilbo Baggins" class="input inputMargin" v-model="character.name" v-on:blur="backupImport">
      Select gift:
      ...
      Max HP: <input type="number" placeholder="0" class="input inputMargin" v-model="character.maxHp" v-on:blur="backupImport">
      Max MP: <input type="number" placeholder="0" class="input inputMargin" v-model="character.maxMp" v-on:blur="backupImport">
      Max Vim: <input type="number" placeholder="0" class="input inputMargin" v-model="character.maxVim" v-on:blur="backupImport">
      Current Hero Points: <input type="number" placeholder="0" class="input inputMargin" v-model="character.hero" v-on:blur="backupImport">
      Max Hero Points: <input type="number" placeholder="0" class="input inputMargin" v-model="character.maxHero" v-on:blur="backupImport">
      Initiative Bonus: <input type="number" placeholder="0" class="input inputMargin" v-model="character.init" v-on:blur="backupImport">
      Speed: <input type="number" placeholder="0" class="input inputMargin" v-model="character.speed" v-on:blur="backupImport">
      Armor: <input type="number" placeholder="0" class="input inputMargin" v-model="character.armor" v-on:blur="backupImport">
      Total XP: <input type="number" placeholder="0" class="input inputMargin" v-model="character.xp" v-on:blur="backupImport">
      SP: <input type="number" placeholder="0" class="input inputMargin" v-model="character.sp" v-on:blur="backupImport">
      <p>You can import items and abilities after you create the character.</p>
      <h2>Import your Character</h2>
      <p>Click the "Create Character" button to officially create the character.</p>
      <p>Click the "Clear Character" button to delete this character and start again.</p>
      <div class="bottomButtons">
        ...
        <ConfirmSelectionButton :defaultText="'Clear Character'" @secondClick="clearCharacter" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    createCharacterButton () {
      ...
      this.$store.dispatch('createCharacter', { character: createCharacter, redirectToCharacter: true })
    }
  }
}
</script>
